...
async function main() {
  ...
  const permissions = [
    ...
    { name: 'admin.access', module: 'admin', action: 'access', description: 'Access admin area' },
    {
    ...
    { name: 'tenant.list', module: 'tenant', action: 'list', description: 'List tenants' },
    { name: 'tenant.create', module: 'tenant', action: 'create', description: 'Create tenants' },
    { name: 'team.read', module: 'team', action: 'read', description: 'Read team members' },
